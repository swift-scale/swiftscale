  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        },
        {
          ...
          desc: "Sales & performance boosting.",
        },
        {
          name: "Logistics",
          href: "/services/ecommerce/logistics",
          desc: "Fulfillment & delivery support.",
        },
        {
          name: "Warehousing",
    ...
    },
    {
      ...
      services: [
        ...
        {
          name: "Cybersecurity",
          href: "/services/consulting/cyber",
          desc: "Enterprise-grade protection.",
        },
        {
          name: "Cloud & DevOps",
          href: "/services/consulting/devops",
          desc: "Automated infra scaling.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          href: "/services/consulting/dev",
          desc: "Strategic scale guidance.",
        },
        {
          name: "IT Infra Roles",
          href: "/services/consulting/infra",
          desc: "Core backend specialists.",
        },
      ],
    },
  ];
