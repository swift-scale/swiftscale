  ...
  return (
    <div className="min-h-screen bg-[#05050A] text-white selection:bg-accent selection:text-white font-sans overflow-x-hidden">
      ...
      <section className="relative pt-40 pb-20 md:pt-52 md:pb-40 min-h-[90vh] flex flex-col justify-center border-b border-white/5">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <img 
            ...
            className="w-full h-full object-cover opacity-60 mix-blend-screen scale-105 animate-in fade-in zoom-in duration-[2000ms]"
          />
          {/* Glowing Orbs */}
        ...
        <div className="container mx-auto px-6 relative z-20 text-center flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500 w-full sm:w-auto">
            <Button size="lg" className="bg-accent hover:bg-accent/90 text-white rounded-full px-12 h-16 text-lg font-bold transition-all shadow-[0_0_40px_rgba(var(--accent-rgb),0.4)] hover:scale-105 hover:shadow-[0_0_60px_rgba(var(--accent-rgb),0.6)] group w-full sm:w-auto">
              Start Free Trial
              <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Button>
            <Button size="lg" variant="outline" className="rounded-full px-12 h-16 text-lg font-medium border-white/20 bg-white/[0.03] text-white hover:bg-white/10 hover:text-white backdrop-blur-md transition-all hover:scale-105 w-full sm:w-auto">
      ...
      <section className="py-40 relative overflow-hidden border-t border-white/5">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,rgba(var(--accent-rgb),0.2),transparent_70%)] pointer-events-none" />
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Button size="lg" className="bg-accent hover:bg-accent/90 text-white rounded-full px-14 h-16 text-xl font-bold transition-all shadow-[0_0_40px_rgba(var(--accent-rgb),0.3)] hover:scale-105">
              Start Your Project
            </Button>
            <Button size="lg" variant="outline" className="rounded-full px-14 h-16 text-xl font-medium border-white/20 bg-white/[0.05] text-white hover:bg-white/10 hover:text-white backdrop-blur-md transition-all hover:scale-105">
              Contact Sales
            </Button>
          </div>
        </div>
