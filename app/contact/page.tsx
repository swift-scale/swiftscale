  ...
  return (
    <>
      ...
      <div className={`min-h-screen bg-[#020205] text-white selection:bg-primary selection:text-white font-sans transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <section className="relative pt-44 pb-32 bg-[#020205] -mt-16 md:-mt-20">
          ...
          <div className="container mx-auto px-6 relative z-10 w-full max-w-7xl font-sans">
            ...
            >
              ...
              <motion.h1 variants={itemVariants} className="text-6xl md:text-8xl font-display font-black leading-none tracking-tight text-white">
                Let's build{" "}
              ...
              <motion.p variants={itemVariants} className="text-white/40 text-lg md:text-xl font-medium max-w-2xl leading-relaxed">
            ...
            <motion.div 
              className="glass-panel rounded-[3.5rem] border border-white/15 overflow-hidden shadow-[0_50px_150px_rgba(0,0,0,0.8)] backdrop-blur-3xl"
